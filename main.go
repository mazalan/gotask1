...
var categories = []Category{
	{ID: 1, Name: "Minuman", Description: "Kategori untuk semua jenis minuman"},
	{ID: 2, Name: "Makanan", Description: "Kategori untuk semua jenis makanan"},
...
/* ==========================
   TUGAS CRUD CATEGORY
   Model: Category { ID, Name, Description }
   Endpoint:
   - GET    /categories
   - POST   /categories
   - PUT    /categories/{id}
